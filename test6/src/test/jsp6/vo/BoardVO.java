...
public class BoardVO {
	...
	public BoardVO(int boardNum, String id) {
		this.boardNum = boardNum;
		this.id = id;
	}
	
	public BoardVO(int boardNum, String id, String title, String content) {
		this.boardNum = boardNum;
		this.id = id;
		this.title = title;
	...
	public BoardVO(int boardNum, String id, String title, String content, String inputdate, int hits, String name) {
		this.boardNum = boardNum;
		this.id = id;
		this.title = title;
		this.content = content;
